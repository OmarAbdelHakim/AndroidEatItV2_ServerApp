        package com.example.androideatitv2_serverapp.common;
        ...
        import com.example.androideatitv2_serverapp.callback.MyButtonClickListener;
        ...
        public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
            ...
            private synchronized void recoverSwipedItems()
            {
            ...
            public class MyButton{
                ...
                public void onDraw(Canvas c , RectF rectF , int pos)
                {
                    ...
                    float x=0 , y = 0;
                    if(imgResId == 0 ) // if just show text
                    {
